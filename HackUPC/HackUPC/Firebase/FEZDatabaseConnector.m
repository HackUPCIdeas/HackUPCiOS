...
- (instancetype)child:(NSString *)identifier {
    FEZDatabaseConnector *connector = [FEZDatabaseConnector linkWithDatabaseName:[NSString stringWithFormat:@"%@/%@", self.databaseName, identifier]];
    return connector;
}
...
- (void)send:(NSDictionary *)message withCompletionBlock:(void(^)(NSString *key, NSError * _Nullable error))completionBlock {
